...
import com.example.finalproject.ui.password.factory.VerificationCodeForgetFactory
...
class VerificationCodeForgetPasswordActivity : BaseActivity() {
    ...
    private fun initView() {
        val verificationCodeForgetPasswordRepository = VerificationCodeForgetRepository(RetrofitClient.instance)
        val factory = VerificationCodeForgetFactory(verificationCodeForgetPasswordRepository)
        verificationCodeForgetPasswordViewModel = ViewModelProvider(
            this@VerificationCodeForgetPasswordActivity, factory)[VerificationCodeForgetPasswordViewModel:: class.java]
    ...
    private fun verifyCode() {
        ...
        if (!verificationCodeString.isNullOrBlank()) {
            ...
            verificationCodeForgetPasswordViewModel.errorLiveData.observe(this) { error ->
                hideProgressDialog()
                error?.let {
                    try {
