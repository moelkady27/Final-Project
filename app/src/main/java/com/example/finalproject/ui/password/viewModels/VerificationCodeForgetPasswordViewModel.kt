...
class VerificationCodeForgetPasswordViewModel(
    ...
    fun verifyForget(otp :Int , email: String){
        ...
        verificationCodeForgetPasswordRepository.verifyForget(otp , email)
    ...
    fun resendCodeForget(email: String) {
        ...
        verificationCodeForgetPasswordRepository.resendCodeForget(email)
